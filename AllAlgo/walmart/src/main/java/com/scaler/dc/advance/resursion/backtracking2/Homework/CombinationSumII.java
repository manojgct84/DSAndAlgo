package com.scaler.dc.advance.resursion.backtracking2.Homework;
...
public class CombinationSumII {
    ...
    private static void
    findCombinationSumII(ArrayList<ArrayList<Integer>> res, ArrayList<Integer> temp, int startIndex, ArrayList<Integer> A, int B) {
